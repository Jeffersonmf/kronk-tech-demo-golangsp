...
## Contexto
As URLs de produto hoje usam o ID interno (ex: `/produtos/a1b2c3`). Para SEO, o time de marketing quer URLs amigáveis baseadas no nome do produto (ex: `/produtos/tenis-de-corrida-azul`).
